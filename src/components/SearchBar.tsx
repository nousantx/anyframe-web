    ...
    <div className="">
      <div className="relative flex ai-center">
        <input
          ...
          className="h-35px px-12px w-full w-mx-150px br-6px bw-1px bs-solid bg-neutral-100 bdr-c-neutral-200 [outline]-none focus:bdr-c-blue-500 tr-300ms text-neutral-800"
        />
        {searchQuery && (
          <button
            onClick={() => {
